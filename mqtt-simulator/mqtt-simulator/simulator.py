        ...
        with open(settings_file) as json_file:
            ...
            for topic in config['TOPICS']:
                ...
                if topic['TYPE'] == 'single':
                    ...
                    self.topics.append(
                        TopicAuto(self.broker_url, self.broker_port, topic_url, topic_data, topic_retain_probability,
                                  topic_time_interval))
                    ...
                    for id in range(topic['RANGE_START'], topic['RANGE_END'] + 1):
                        ...
                        self.topics.append(TopicAuto(self.broker_url, self.broker_port, topic_url, topic_data,
                                                     topic_retain_probability, topic_time_interval))
